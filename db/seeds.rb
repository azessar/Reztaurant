...
user6 = User.create!(first_name: 'Sheldon', last_name: 'P', email: 'plankton@chum.com', primary_dining_location: 'Bikini Bottom', password: 'password')
...
file1b = URI.open('https://reztaurant-seeds.s3.us-east-2.amazonaws.com/krustykrabbackup.jpg')
...
file3b = URI.open('https://reztaurant-seeds.s3.us-east-2.amazonaws.com/threeburgers.jpeg')
...
file8b = URI.open('https://reztaurant-seeds.s3.us-east-2.amazonaws.com/default_show_background.png')
restaurant8.background_photo.attach(io: file8b, filename: 'default_show_background.png')
...
file9b = URI.open('https://reztaurant-seeds.s3.us-east-2.amazonaws.com/threeburgers.jpeg')
...
file10b = URI.open('https://reztaurant-seeds.s3.us-east-2.amazonaws.com/fried_chicken.jpeg')
